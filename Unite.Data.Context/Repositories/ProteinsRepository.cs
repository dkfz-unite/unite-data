...
public class ProteinsRepository : Repository
{
    ...
    public async Task<int[]> GetRelatedSpecimens(IEnumerable<int> ids, SpecimenType? typeId = null)
    {
        ...
        (
            ...
            GetGeneExpressionRelatedSpecimens(ids, typeId),
            GetProteinExpressionRelatedSpecimens(ids, typeId)
        );
    ...
    public async Task<int[]> GetGeneExpressionRelatedSpecimens(IEnumerable<int> ids, SpecimenType? typeId = null)
    {
        using var dbContext = _dbContextFactory.CreateDbContext();
    ...
    public async Task<int[]> GetProteinExpressionRelatedSpecimens(IEnumerable<int> ids, SpecimenType? typeId = null)
    {
        using var dbContext = _dbContextFactory.CreateDbContext();
